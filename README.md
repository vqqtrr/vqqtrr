...
|[Дашборд с вакансиями в сфере "Data Science" на HH.ru](https://public.tableau.com/app/profile/vikotr.panchenko/viz/DashboardHHPanchenkoViktor/sheet15?publish=yes)|Дашборд, который выводит метрики анализа рынка в сфере "Data Science". Датасет с вакансиями взят с сайта "HeadHunter.ru"|**Tableau**|
